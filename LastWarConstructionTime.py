...
BUILDING_DATA = {
    ...
    "11 → 12": {"time": (0, 8, 24, 0),  "res": (2.8, 2.8, 0.89)},
    "12 → 13": {"time": (0,10, 54, 0),  "res": (3.1, 3.1, 0.98)},
    "13 → 14": {"time": (0,14, 12, 0),  "res": (4.3, 4.3, 1.4)},
    "14 → 15": {"time": (0,19, 54, 0),  "res": (6.0, 6.0, 1.9)},
    "15 → 16": {"time": (1, 2, 24, 0),  "res": (11, 11, 3.4)},
    "16 → 17": {"time": (1,14, 24, 0),  "res": (14, 14, 4.4)},
    "17 → 18": {"time": (2, 4, 48, 0),  "res": (24, 24, 7.8)},
    "18 → 19": {"time": (3, 2, 24, 0),  "res": (29, 29, 9.3)},
    "19 → 20": {"time": (4, 9, 36, 0),  "res": (52, 52, 17)},
    "20 → 21": {"time": (5,16, 48, 0),  "res": (73, 73, 23)},
    "21 → 22": {"time": (7,12,  0, 0),  "res": (95, 95, 30)},
    "22 → 23": {"time": (9,16, 48, 0),  "res": (120,120,38)},
    "23 → 24": {"time": (13,14,24,0),  "res": (150,150,48)},
    "24 → 25": {"time": (19, 2,24,0),  "res": (250,250,81)},
    "25 → 26": {"time": (26,19,12,0),  "res": (350,350,110)},
    "26 → 27": {"time": (37,12, 0,0),  "res": (460,460,150)},
    "27 → 28": {"time": (52,14,24,0),  "res": (640,640,210)},
    "28 → 29": {"time": (68, 7,12,0),  "res": (900,900,290)},
    "29 → 30": {"time": (88,21,36,0),  "res": (1300,1300,400)},
},
    "병영": {},
    "병원": {},
    "탱크 센터": {},
