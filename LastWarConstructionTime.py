...
BUILDING_DATA = {
    "본부(Headquarters)": {
        ...
        "13 → 14": {"time": (0,16,13, 6), "res": (4.9,4.9,1.6), "req": ("과학센터13","연병장13")},
        "14 → 15": {"time": (0,22,42,20), "res": (6.8,6.8,2.2), "req": ("과학센터14","베리어14")},
        "15 → 16": {"time": (1, 7,47,15), "res": (12,12,3.9),  "req": ("과학센터15","연맹센터15")},
        "16 → 17": {"time": (1,20,30, 9), "res": (16,16,5.1),  "req": ("과학센터16","탱크센터16")},
        "17 → 18": {"time": (2, 1,18,13), "res": (28,28,8.9),  "req": ("과학센터17","병원17")},
        "18 → 19": {"time": (3,15,13,29), "res": (33,33,11),   "req": ("과학센터18","베리어18")},
        "19 → 20": {"time": (5, 2, 6,53), "res": (60,60,19),   "req": ("과학센터19","병영19")},
        "20 → 21": {"time": (6,14,44,57), "res": (84,84,27),   "req": ("과학센터20","탱크센터20")},
        "21 → 22": {"time": (8,14,22,26), "res": (110,110,35), "req": ("과학센터21","연병장21")},
        "22 → 23": {"time": (11,4,17, 9), "res": (140,140,44), "req": ("과학센터22","베리어22")},
        "23 → 24": {"time": (15,15,36,1), "res": (170,170,54), "req": ("과학센터23","연맹센터23")},
        "24 → 25": {"time": (21,21,50,25),"res": (290,290,93), "req": ("과학센터24","탱크센터24")},
        "25 → 26": {"time": (30,16,10,35),"res": (400,400,130),"req": ("과학센터25","병원25")},
        "26 → 27": {"time": (42,22,38,49),"res": (530,530,170),"req": ("과학센터26","베리어26")},
        "27 → 28": {"time": (60, 2,54,20),"res": (740,740,240),"req": ("과학센터27","병영27")},
